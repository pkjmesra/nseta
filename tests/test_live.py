...
from nseta.live.live import get_quote, get_futures_chain_table, get_holidays_list, isworkingday, nextworkingday, previousworkingday, getworkingdays
...
from nseta.derivatives import get_expiry_date
...
class TestLiveUrls(unittest.TestCase):
    ...
    def test_get_quote_index_der(self):
        ...
        # So test for only >=3
        self.assertGreaterEqual(len(stexp), 1)
